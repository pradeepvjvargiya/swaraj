...
jQuery(document).ready(function () {
    jQuery(".img-carousel").owlCarousel({
        ...
        jQuery(".project-carousel-2").owlCarousel({
            ...
            dots: !0,
            navText: ['<i class="fa fa-angle-left"></i>', '<i class="fa fa-angle-right"></i>'],
            responsive: { 0: { items: 1, stagePadding: 60, margin: 15 }, 480: { items: 1, margin: 15, stagePadding: 60 }, 768: { items: 1 }, 1000: { items: 1.5 } },
        }),
        ...
        jQuery(".owl-project").owlCarousel({
            ...
            responsive: { 0: { items: 1 }, 480: { items: 2, margin: 15 }, 700: { items: 2, margin: 15 }, 1024: { items: 3 }, 1200: { items: 3 } },
        }),
