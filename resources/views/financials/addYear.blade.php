...
@section('content')
    <div class="container">
        <h5 class="col-lg-12 mb-3 text-center">Add Financial Year</h5>
        <form class="col-lg-12 row" action="{{ route('financials.store') }}" method="post" enctype="multipart/form-data"
            autocomplete="off">
            @csrf
            <div class="row">
                <label for="year" class="col-lg-4 col-form-label">Financial Year:</label>
                <div class="col-lg-8">
