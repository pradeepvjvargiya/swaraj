            ...
            <tbody>
                @foreach ($financials as $key => $financial)
                    <tr>
                        ...
                        <td>
                            <a href="{{ asset('storage/' . $financial->filepath) }}" target="_blank" data-toggle="tooltip"
                        ...
                        <td>
                            @foreach ($financial->getQuarterDocs($financial->year, 'Q1') as $doc)
                                ...
                                <a href="{{ route('financials.destroyQuarter', ['year' => $doc->year, 'quarter' => 'Q1', 'id' => $doc->id]) }}"
                                    data-toggle="tooltip" data-placement="top" title="Delete Quarter"><i class="fa fa-trash"
                        ...
                        <td>
                            <a href="{{ url('/financials/delete/' . $financial->id) }}" class="btn btn-primary" onclick="return confirmDelete()" data-toggle="tooltip" data-placement="top" title="Delete Year"><i class="fa fa-trash" aria-hidden="true"></i></a>
