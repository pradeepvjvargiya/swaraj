...
@section('content')
    <div class="container">
        <h5 class="col-lg-12 mb-3 text-center">Edit Financial Year</h5>
        <form class="col-lg-12 row" action="{{ route('financials.updateYear', ['id' => $financial->id]) }}"
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <input type="text" name="year" id="title" value="{{ $financial->year }}" class="form-control"
