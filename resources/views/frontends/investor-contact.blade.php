        ...
        <div class="dlab-bnr-inr dlab-bnr-inr-sm overlay-black-dark banner-content "
            ...
            <div class="container">
                <div class="dlab-bnr-inr-entry">
                    <h1 class="text-white">Investor Contact </h1>
                    <!-- Breadcrumb row -->
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 d-flex m-b30">
                        <div class="p-a30 border contact-area border-1 align-self-stretch radius-sm">
                            <h3 class="m-b5">Registered Office Address</h3>
                            <ul class="no-margin">
                                ...
                                <li class="icon-bx-wraper left  m-b30">
                                    <div class="icon-bx-xs border-1"> <a href="javascript:void(0);" class="icon-cell"><i
                                                class="ti-world"></i></a> </div>
                                    <div class="icon-content">
                                        <h6 class="text-uppercase m-tb0 dlab-tilte">Website:</h6>
                                        <p>www.swarajsuiting.com</p>
                                    </div>
                                </li>
                            </ul>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex m-b30">
                        <div class="p-a30 border contact-area border-1 align-self-stretch radius-sm">
                            <h3 class="m-b5">Registrar &amp; Transfer Agent</h3>
                            <ul class="no-margin">
                                <li class="icon-bx-wraper left m-b30">
                                    <div class="icon-bx-xs border-1"> <a href="javascript:void(0);" class="icon-cell"><i
                                                class="ti-location-pin"></i></a> </div>
                                    <div class="icon-content">
                                        <h6 class="text-uppercase m-tb0 dlab-tilte">Address:</h6>
                                        <p>M/s Bigshare Services Pvt. Ltd.
                                            1st Floor, Bharat Tin Works Buildings
                                            Opposite Vasant Oasis, Makawana Road
                    ...
                    <div class="col-lg-4 col-md-6 d-flex m-b30">
                        <div class="p-a30 border contact-area border-1 align-self-stretch radius-sm">
                            <h3 class="m-b5">Compliance Officer</h3>
                            <ul class="no-margin">
                                <li class="icon-bx-wraper left m-b30">
                                    <div class="icon-bx-xs border-1"> <a href="javascript:void(0);" class="icon-cell"><i
                                                class="ti-location-pin"></i></a> </div>
